...
public class CliMainOptions {
   ...
   */
  @Option(name = "e", longName = "exitonfailure",
   ...
   */
  @Option(name = "n", longName = "noninteract",
   ...
   */
  @Option(name = "a", longName = "appendtooutput",
